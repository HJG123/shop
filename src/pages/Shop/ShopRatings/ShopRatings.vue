  ...
  <div class="ratings" ref="ratings">
    <div class="ratings-content">
      ...
      <div class="ratingselect">
        <div class="rating-type border-1px">
          ...
          <span class="block positive" :class="{active:selectType===0}" @click="setSelectType(0)">
            满意
            <span class="count">{{positveSize}}</span>
          </span>
          <span class="block negative" :class="{active:selectType===1}" @click="setSelectType(1)">
            不满意
            <span class="count">{{ratings.length-positveSize}}</span>
          </span>
        </div>
        <div class="switch" :class="{on : onlyText}" @click="toggleShowOnlyText">
      ...
      <div class="rating-wrapper">
        <ul>
          <li class="rating-item" v-for="(rating, index) in ratingFilter" :key="index">
            <div class="avatar">
              <img
                width="28"
                height="28"
...
export default {
    data(){
      return{
        onlyText:true,  //是否只显示有内容的评论
        selectType:2    //选择的评价内容: 0-满意 1-不满意 2-全部
      }
    },
    mounted(){
