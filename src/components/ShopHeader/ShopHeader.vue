<template>
    ...
    <transition name="fade">
        <div class="shop-brief-modal" v-show="shopShow">
            ...
            <div class="brief-modal-cover" v-show="shopShow"></div>
        </div>
    </transition>
    ...
    <div class="activity-sheet" v-show="supportShow">
        <div class="activity-sheet-content">
            ...
            <ul class="list">
                <li class="activity-item" :class="supportClasses[info.supports[index].type]" v-for="(item, index) in info.supports" :key="index">
                    <span class="content-tag">
